...
```
/captain-claude:instructions                          # view all
/captain-claude:instructions plan                     # view plan instructions
/captain-claude:instructions plan --edit              # edit plan instructions
/captain-claude:instructions implementation --edit    # edit implementation instructions
/captain-claude:instructions review --edit            # edit review instructions
/captain-claude:instructions <phase> --reset          # restore defaults for a phase
```
